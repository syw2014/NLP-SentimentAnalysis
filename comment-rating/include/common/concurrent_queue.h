 ...
 */
// Tips: 
//      when to use the concurrent queue,you may do like this
//      concurrent_queue<T>* qu_;
//      qu_ =  new concurrent_queue<T>(the size of queue);
//      qu_->push(T& data);
//      qu_->pop(T& data); or qu_->pop(T& data, Process Function);
//
